...
@section('contenido')
    <div class="p-2 rounded-xl w-1/2 mx-auto border-2 border-black shadow-xl">
        <form METHOD="post" action="{{ route('roles.store') }}">
            @csrf
            <div class="mb-5">
                <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre Rol</label>
            ...
            <div class="mb-5">
                <label for="color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color Rol</label>
