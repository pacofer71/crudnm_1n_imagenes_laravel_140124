        ...
        <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select id="departament_id" name="departament_id"
                    ...
                    @foreach ($departamentos as $departament)
                        <option value="{{ $departament->id }}" @selectd(old('departament_id')==$departament_id)>{{ $departament->nombre }}</option>
                    @endforeach
                </select>
            ...
            <div class="mb-4">
                ...
                <div class="space-y-2 mt-2">
                    ...
                    <div>
                        <input type="checkbox" id="{{ $role->id }}" name="role_id[]" value="{{ $role->id }}" @checked(in_array( $role->id, old('role_id', [])))
            ...
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="w-24 h-24 border rounded-lg overflow-hidden bg-gray-50">
                    <img id="preview" src="" alt="Vista previa" class="w-full h-full object-cover">
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4 mt-4">
                ...
                <button type="reset"
                    class="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500">
